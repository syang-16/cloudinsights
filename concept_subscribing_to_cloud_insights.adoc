...
//NOTE: You must log in at least once every 90 days to continue using Cloud Insights Basic Edition, or your environment is considered inactive. Environments inactive for 90 days will be deleted and their resources reclaimed. Standard and higher Editions do not have this restriction.

WARNING: Inactive Cloud Insights Basic Edition environments are deleted and their resources are reclaimed. An environment is considered inactive if there is no user activity for 90 consecutive days. Standard and higher Editions do not have this restriction.
...
* *Basic Edition* is free and gives you 7 days of data retention and access to Cloud Insights basic features. Basic Edition supports NetApp-only data collectors; if you choose to subscribe to Basic Edition, any non-NetApp data collectors you have configured will be removed. You must have at least one NetApp data collector acquiring data for at least 7 days before you can subscribe to Basic Edition.

* *Standard Edition* gives you everything included in Basic Edition, plus an increase to 90 days of data retention as well as access to NetApp Technical Support. Standard Edition includes acquisition of all data collectors supported by Cloud Insights.
////
...
* Current subscription (Trial, Basic, Standard, etc.) 
