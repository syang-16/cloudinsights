...
NOTE: If you do not log in to your Cloud Insights Basic Edition environment for 90 days, your environment will be deleted. You must log in at least once every 90 days to continue using Cloud Insights Basic Edition. Standard and higher Editions do not have this restriction.
