...
NOTE: You must log in at least once every 90 days to continue using Cloud Insights Basic Edition, or your environment is considered inactive. Environments inactive for 90 dyas will be deleted and their resources reclaimed. 
+
Standard and higher Editions do not have this restriction.
